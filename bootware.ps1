...
Function Bootstrap() {
    ...
    $Skip = 'none'
    $Tags = 'desktop'
    $URL = 'https://github.com/0xO0O0/stinkyboots.git'
    $UseSetup = 1
    $User = "$Env:UserName"
...
Function SetupWSL($Branch) {
    ...
    If (-Not (wsl command -v bootware)) {
        ...
        wsl curl -LSfs `
            https://raw.githubusercontent.com/0xO0O0/stinkyboots/main/install.sh `
...
Function Update() {
    ...
    $SrcURL = "https://raw.githubusercontent.com/0xO0O0/stinkyboots/$Version/bootware.ps1"
